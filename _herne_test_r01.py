...
root_path = Path("J:\\32_IZ224_SIEMENS_Herne\\60_Construction\\20_Sx_Working\\50_Workfiles\\01_Deleted lines")
exclude_dir = ["00_Archive", "00_archive", "01_Archive", "01_archive", "00_Document_templates", "SKID", "02_Red_Corex", "03_Additional_Workfiles", "Deleted"]     # excluded folders (these are skipped)

dlist = dl.dir_list(root_path, obj_type="f", src_for="60*BR*", ext="pdf", exclude=exclude_dir)    # list of required files
